...
1. [Flaws in Web Applications](#flaws-in-web-applications)
   - [SQL Injection](#sql-injection)
   - [File Inclusion](#file-inclusion)
   - [Unrestricted File Upload](#unrestricted-file-upload)
   - [Insecure Direct Object Referencing (IDOR)](#insecure-direct-object-referencing-idor)
   - [Broken Access Control](#broken-access-control)
   - [Password Spraying Attack](#password-spraying-attack)
     - [How It Works](#how-it-works)

2. [Layers in Web Applications Layout](#layers-in-web-applications-layout)
...
3. [Web Application Infrastructure](#web-application-infrastructure-1)
...
4. [Web Application Components](#web-application-components-1)
   - [Clients](#clients)
   - [Server](#server)
     - [Web Server](#web-server)
     - [Web Application Logic](#web-application-logic)
     - [Database](#database)
   - [Services (Microservices)](#services-microservices)
     - [Third Party Integrations](#third-party-integrations)
     - [Web Applications Integrations](#web-applications-integrations)
   - [Functions (Serverless)](#functions-serverless)

5. [Web Application Architecture](#web-application-architecture-1)
